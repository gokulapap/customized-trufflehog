...
func (s Scanner) Type() detectorspb.DetectorType {
	return detectorspb.DetectorType_NetrcFile
}

func (s Scanner) Description() string {
	return "netrc files with plaintext machine/login/password credentials for arbitrary hosts."
}
