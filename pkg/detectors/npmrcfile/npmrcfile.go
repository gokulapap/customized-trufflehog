...
func (s Scanner) Type() detectorspb.DetectorType {
	return detectorspb.DetectorType_NpmrcFile
}

func (s Scanner) Description() string {
	return "npmrc files containing registry auth tokens (_authToken/_auth) that TruffleHog's npm UUID detector often misses."
}
