...
func (s Scanner) Type() detectorspb.DetectorType {
	return detectorspb.DetectorType_HtpasswdFile
}

func (s Scanner) Description() string {
	return "htpasswd files containing username:hash pairs used to gate admin panels and basic-auth endpoints."
}
...
func (s Scanner) FilenamePatterns() []string {
	return []string{".htpasswd", "*.htpasswd"}
}
