...
func (s Scanner) Type() detectorspb.DetectorType {
	return detectorspb.DetectorType_KubeConfigFile
}

func (s Scanner) Description() string {
	return "Kubernetes kubeconfig files containing cluster endpoints, client certificates, and bearer tokens."
}
...
func (s Scanner) FilenamePatterns() []string {
	return []string{".kube/config", "kubeconfig", "*.kubeconfig"}
}
