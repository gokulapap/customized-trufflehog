...
func (s Scanner) Type() detectorspb.DetectorType {
	return detectorspb.DetectorType_WpConfigFile
}

func (s Scanner) Description() string {
	return "WordPress wp-config.php files containing database credentials and authentication salts/keys."
}
